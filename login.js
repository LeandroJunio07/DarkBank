document.addEventListener('DOMContentLoaded', function() {
    ...
    loginForm.addEventListener('submit', function(e) {
        ...
        // Credenciais válidas
        const CPF_VALIDO = '09620861183';
        const SENHA_VALIDA = 'leandro123';
        
        if (cpf === CPF_VALIDO && senha === SENHA_VALIDA) {
            localStorage.setItem('darkbank_logged_in', 'true');
    ...
    esqueciSenha.addEventListener('click', function(e) {
        e.preventDefault();
        alert('Solicitação de recuperação de senha enviada para seu e-mail cadastrado.');
    });
